...
def galex_button(
    ...
    for galaxy in galaxies:
        ...
        if not os.path.exists(galaxy + '_FUV.fits') or \
                not os.path.exists(galaxy + '_NUV.fits') or overwrite:
            ...
            for galex_filter in filters:
                ...
                if os.path.exists(galaxy + '_' + galex_filter + '.fits') and \
                        not overwrite:
                    continue
                ...
                for match in matches:
                    ...
                    os.rename(
                        match[:-3],
                        galaxy + '/' + galex_filter + '/' +
                        galaxy + '_' + str(filename_ext) + '.fits')
        ...
        shutil.rmtree('galex_temp/' + galaxy,
                      ignore_errors=True,
                      )
